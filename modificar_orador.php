<?php
    ...
    $ID=$_GET["ID"];
    $sql=$conexion->query(" select * from orador where ID=$ID");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<h3 class="text-center text-secondary">Modificar Oradores</h3>
<input type="hidden" name="ID" value="<?=$_GET["ID"]?>">
<?php
            include "controller/modificar_oradores.php";
            ...
            <button type="submit" class="btn btn-primary" name="btnmodorador" value="ok">Modificar Orador</button>
